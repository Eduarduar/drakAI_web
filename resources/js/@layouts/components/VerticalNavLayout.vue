...
export default defineComponent({
  setup(props, { slots }) {
    ...
    return () => {
      ...
      // Sin barra superior: la app es un flujo de una sola página, así que
      // el header se colapsa a 0 siempre (desktop y mobile) — el botón de
      // menú para mobile vive como botón flotante independiente (ver
      // DefaultLayoutWithVerticalNav.vue).
      const collapseNavbar = true
