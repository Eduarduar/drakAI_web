export const staticPrimaryColor = '#6D5AE0'
export const staticPrimaryHoverColor = '#5747C7'

export const staticPrimaryDarkenColor = '#8B7FF0'
export const staticPrimaryDarkHoverColor = '#7A6ADB'
...
export const themes = {
  light: {
    ...
    colors: {
      ...
      'on-primary': '#fff',
      'primary-darken-1': staticPrimaryHoverColor,
  ...
  dark: {
    ...
    colors: {
      ...
      'on-primary': '#fff',
      'primary-darken-1': staticPrimaryDarkHoverColor,
      'primary-light': '#8789FF',
      'secondary': '#8592A3',
      'on-secondary': '#fff',
      'secondary-darken-1': '#788393',
